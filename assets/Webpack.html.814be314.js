import{_ as e,o as n,c as i,e as s}from"./app.37a6fc76.js";const l={},d=s(`<h1 id="webpack" tabindex="-1"><a class="header-anchor" href="#webpack" aria-hidden="true">#</a> Webpack</h1><h1 id="webpack-1" tabindex="-1"><a class="header-anchor" href="#webpack-1" aria-hidden="true">#</a> <strong>Webpack</strong></h1><h1 id="一、webpack入门" tabindex="-1"><a class="header-anchor" href="#一、webpack入门" aria-hidden="true">#</a> <strong>一、Webpack入门</strong></h1><p><strong><strong>Webpack简介</strong></strong></p><blockquote><p>webpack是当前前端最热门的前端资源模块化管理和打包工具。</p></blockquote><p><strong><strong>安装Webpack</strong></strong></p><p>首先要安装Node.js，Node.js自带了软件包管理工具npm，可以使用npm安装各种插件。Webpack至少需要Node.js v0.6版本，直接安装最新版就好了。</p><p>新建一个目录，初始化npm</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>npm init
