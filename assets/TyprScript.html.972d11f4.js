import{_ as d,r as a,o as r,c as v,a as e,b as n,d as s,e as l}from"./app.37a6fc76.js";const t={},c=l('<h1 id="typrscript" tabindex="-1"><a class="header-anchor" href="#typrscript" aria-hidden="true">#</a> TyprScript</h1><h1 id="typrscript基础知识" tabindex="-1"><a class="header-anchor" href="#typrscript基础知识" aria-hidden="true">#</a> <strong>TyprScript基础知识</strong></h1><h1 id="一、typrscript安装与编译" tabindex="-1"><a class="header-anchor" href="#一、typrscript安装与编译" aria-hidden="true">#</a> <strong>一、TyprScript安装与编译</strong></h1><p><strong><strong>TyprScript介绍</strong></strong></p><blockquote><p>TypeScript是JavaScript类型的超集，它可以编译成纯JavaScript。TypeScript可以在任何浏览器、任何计算机和任何操作系统上运行，并且是开源的。</p></blockquote>',5),u={href:"https://www.tslang.cn/",target:"_blank",rel:"noopener noreferrer"},m=l(`<p><strong><strong>TyprScript</strong></strong></p><p>TypeScript可以编译出纯净、 简洁的JavaScript代码，并且可以运行在任何浏览器上、Node.js环境中和任何支持ECMAScript 3（或更高版本）的JavaScript引擎中。</p><p><strong><strong>安装环境</strong></strong></p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>npm i typescript -g //全局安装typescript
