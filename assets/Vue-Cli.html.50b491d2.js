import{_ as e,o as i,c as n,e as s}from"./app.629164ab.js";const l="/assets/Untitled.a83c3c01.png",d={},a=s(`<h1 id="vue-cli" tabindex="-1"><a class="header-anchor" href="#vue-cli" aria-hidden="true">#</a> Vue-Cli</h1><h1 id="vue-cli-脚手架相关" tabindex="-1"><a class="header-anchor" href="#vue-cli-脚手架相关" aria-hidden="true">#</a> <strong>Vue-Cli 脚手架相关</strong></h1><h1 id="一、创建vue项目" tabindex="-1"><a class="header-anchor" href="#一、创建vue项目" aria-hidden="true">#</a> <strong>一、创建vue项目</strong></h1><p><strong><strong>基于 交互式命令行 的方式，创建新版vue项目</strong></strong></p><p>创建vue-cli2的项目时，使用的命令行是：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>vue init webpack project-name
