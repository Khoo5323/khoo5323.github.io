import{_ as e,o as i,c as n,e as s}from"./app.37a6fc76.js";const t="/assets/Untitled.cf36d2b1.png",l={},d=s('<h1 id="vuex" tabindex="-1"><a class="header-anchor" href="#vuex" aria-hidden="true">#</a> Vuex</h1><h1 id="vuex-状态管理器" tabindex="-1"><a class="header-anchor" href="#vuex-状态管理器" aria-hidden="true">#</a> <strong>Vuex 状态管理器</strong></h1><h1 id="一、vuex-状态管理器" tabindex="-1"><a class="header-anchor" href="#一、vuex-状态管理器" aria-hidden="true">#</a> <strong>一、Vuex 状态管理器</strong></h1><p><strong><strong>Vuex的原理</strong></strong></p><blockquote><p>概念：Vuex 是一个专为 Vue.js 应用程序开发的状态管理模式。它采用集中式存储管理应用的所有组件的状态，并以相应的规则保证状态以一种可预测的方式发生变化。</p></blockquote><p>应用场景：Vue多个组件之间需要共享数据或状态。</p><p>Vuex有几个核心属性：State、Getter、Mutation、Action、Module。</p><p><img src="'+t+`" alt="Untitled"></p><ul><li>State：存储状态数据</li><li>Getter：从状态数据派生数据，相当于State的计算属性。</li><li>Mutation：存储用于同步更改状态数据的方法，默认传入的参数为state。</li><li>Action：存储用于异步更改状态数据，但不是直接更改，而是通过触发Mutation方法实现，默认参数为context。</li><li>Module：Vuex模块化。</li></ul><p><strong><strong>全局配置Vuex</strong></strong></p><p>在 src 目录下创建 store 文件夹,并在里面创建一个index.js文件，然后index.js中配置如下：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>// 第一步：引入Vue、和Vuex(固定写法)
import Vue from &#39;vue&#39;
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>sync修饰符，与我们平常使用$emit实现父子组件通信没有区别，只不过是写法上方便一些。当然，利用引用类型的特性实现双向绑定我认为也并非完全不可取。</p><p><strong><strong>vuex的适用场景</strong></strong></p><p>在项目开发中，可能会有很多数据或者参数我们可能需要多次读取或者修改，像购物车等类似功能，这个时候我们的就可以用vuex来实现；vuex毕竟只是一个状态管理模式，状态管理模式是给我们提供方便的，但不是必需的，因为状态管理能做的事通过其他途径和办法也能实现。</p>`,41),a=[d];function r(u,v){return i(),n("div",null,a)}const o=e(l,[["render",r],["__file","VueX.html.vue"]]);export{o as default};
