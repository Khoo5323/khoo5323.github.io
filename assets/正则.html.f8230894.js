import{_ as s,r as a,o as r,c as l,a as n,b as e,d,e as i}from"./app.629164ab.js";const o={},v=i(`<h1 id="正则" tabindex="-1"><a class="header-anchor" href="#正则" aria-hidden="true">#</a> 正则</h1><h1 id="javascript执行上下文、浅拷贝和深拷贝、正则" tabindex="-1"><a class="header-anchor" href="#javascript执行上下文、浅拷贝和深拷贝、正则" aria-hidden="true">#</a> <strong>JavaScript执行上下文、浅拷贝和深拷贝、正则</strong></h1><h1 id="一、浅拷贝和深拷贝" tabindex="-1"><a class="header-anchor" href="#一、浅拷贝和深拷贝" aria-hidden="true">#</a> <strong>一、浅拷贝和深拷贝</strong></h1><p><strong><strong>什么是浅拷贝和深拷贝</strong></strong></p><p>在讲两者概念之前我们先看一个需求：现在有一个对象A，需求是将A拷贝一份到B对象当中？</p><p>浅拷贝</p><p>当B拷贝了A的数据，且当B的改变会导致A的改变时，此时叫B浅拷贝了A，例如：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>//浅拷贝
var A={
    name:&quot;martin&quot;,
    data:{num:10}
}
