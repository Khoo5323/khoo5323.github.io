import{_ as r,r as d,o as a,c as o,a as e,b as i,d as t,t as u,e as l}from"./app.37a6fc76.js";const v="/assets/Untitled.3c453237.png",c="/assets/Untitled1.a356cf9c.png",p={},g=l('<h1 id="vue3-x-基础" tabindex="-1"><a class="header-anchor" href="#vue3-x-基础" aria-hidden="true">#</a> Vue3.X 基础</h1><h1 id="vue3-x-基础-指令、计算、侦听、修饰符等" tabindex="-1"><a class="header-anchor" href="#vue3-x-基础-指令、计算、侦听、修饰符等" aria-hidden="true">#</a> <strong>Vue3.X 基础（指令、计算、侦听、修饰符等）</strong></h1><h1 id="一、vue3-x-介绍" tabindex="-1"><a class="header-anchor" href="#一、vue3-x-介绍" aria-hidden="true">#</a> <strong>一、Vue3.X 介绍</strong></h1><p><strong><strong>Vue3简介</strong></strong></p><p>2020年9月18日，Vue.js发布3.0版本，代号：One Piece（海贼王）</p><p>github上的tags地址：https://github.com/vuejs/vue-next/releases/tag/v3.0.0</p>',6),m={href:"https://cn.vuejs.org/",target:"_blank",rel:"noopener noreferrer"},b={href:"https://v3.cn.vuejs.org/guide/introduction.html",target:"_blank",rel:"noopener noreferrer"},h=l('<p><strong><strong>Vue3带来了什么</strong></strong></p><p><strong>1.性能的提升</strong></p><ul><li>打包大小减少41%</li><li>初次渲染快55%, 更新渲染快133%</li><li>内存减少54%</li><li>......</li></ul><p><strong>2.源码的升级</strong></p><ul><li>使用Proxy代替defineProperty实现响应式</li><li>重写虚拟DOM的实现和Tree-Shaking</li><li>......</li></ul><p><strong>3.拥抱TypeScript</strong></p><p>Vue3可以更好的支持TypeScript</p><p><strong>4.新的特性</strong></p><ul><li><ol><li>Composition API（组合API）</li></ol><ul><li>setup配置</li><li>ref与reactive</li><li>watch与watchEffect</li><li>provide与inject</li></ul></li><li><ol start="2"><li>新的内置组件</li></ol><ul><li>Fragment</li><li>Teleport</li><li>Suspense</li></ul></li><li><ol start="3"><li>其他改变</li></ol><ul><li>新的生命周期钩子</li><li>data 选项应始终被声明为一个函数</li><li>移除keyCode支持作为 v-on 的修饰符</li><li>......</li></ul></li></ul><p><strong><strong>创建Vue3.0工程</strong></strong></p><p><strong>1.使用 Vue-cli 创建</strong></p><p>官方文档：https://cli.vuejs.org/zh/guide/creating-a-project.html#vue-create</p>',12),x={href:"https://cli.vuejs.org/zh/guide/creating-a-project.html#vue-create",target:"_blank",rel:"noopener noreferrer"},f=l(`<p>查看@vue/cli版本，确保@vue/cli版本在4.5.0以上</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>vue --version
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>2.使用 Vite 创建</strong></p><p>官方文档：https://v3.cn.vuejs.org/guide/installation.html#vite</p><p>Vite官网：https://vitejs.cn</p>`,11),V={href:"https://vitejs.cn/",target:"_blank",rel:"noopener noreferrer"},y={href:"https://v3.cn.vuejs.org/guide/installation.html#vite",target:"_blank",rel:"noopener noreferrer"},w=l('<p><strong>什么是Vite？—— 新一代前端构建工具。</strong></p><p>优势如下：</p><ul><li>开发环境中，无需打包操作，可快速的冷启动。</li><li>轻量快速的热重载（HMR）。</li><li>真正的按需编译，不再等待整个应用编译完成。</li></ul><p>传统构建 与 vite构建对比图</p><p><img src="'+v+`" alt="Untitled"></p><p>创建工程</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>npm init vite-app &lt;project-name&gt;
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>移除</strong>过滤器（filter）</p><p>过滤器虽然这看起来很方便，但它需要一个自定义语法，打破大括号内表达式是 “只是 JavaScript” 的假设，这不仅有学习成本，而且有实现成本！建议用方法调用或计算属性去替换过滤器。</p>`,125);function R(s,P){const n=d("ExternalLinkIcon");return a(),o("div",null,[g,e("p",null,[e("a",m,[i("Vue官网"),t(n)]),e("a",b,[i("Vue3.0手册"),t(n)])]),h,e("p",null,[e("a",x,[i("Vue-cli官方文档"),t(n)])]),f,e("p",null,[e("a",V,[i("Vite官网"),t(n)]),e("a",y,[i("Vite官方文档"),t(n)])]),w,e("p",null,u(s.xxx),1),_])}const j=r(p,[["render",R],["__file","Vue3.X基础.html.vue"]]);export{j as default};
