...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>执行上下文生命周期</strong></p><ul><li>创建阶段 <ul><li>生成变量对象 <ul><li>创建arguments</li><li>扫描函数声明</li><li>扫描变量声明</li></ul></li><li>建立作用域链</li><li>确定this的指向</li></ul></li><li>执行阶段 <ul><li>变量赋值</li><li>函数的引用</li><li>执行其他代码</li></ul></li></ul><p><img src="http://vue.cnsbq.com/notebook/static/images/shangxiawen.jpg" alt="http://vue.cnsbq.com/notebook/static/images/shangxiawen.jpg"></p><p><strong><strong>执行上下文栈</strong></strong></p><p>执行上下文栈的作用是用来跟踪代码的，由于JS是单线程的，每次只能做一件事情，其他的事情会放在指定的上下文栈中排队等待执行。</p><p>JS解释器在初始化代码的时候，首先会创建一个新的全局执行上下文到执行上下文栈顶中，然后随着每次函数的调用都会创建一个新的执行上下文放入到栈顶中，随着函数执行完毕后被执行上下文栈顶弹出，直到回到全局的执行上下文中。（栈：一种数据结构，遵循后进先出的原则）。示例如下</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>function getName() {
    const year = getYear();
