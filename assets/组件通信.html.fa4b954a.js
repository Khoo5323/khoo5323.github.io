import{_ as e,o as n,c as i,e as s}from"./app.37a6fc76.js";const t={},d=s(`<h1 id="组件通信" tabindex="-1"><a class="header-anchor" href="#组件通信" aria-hidden="true">#</a> 组件通信</h1><h1 id="vue组件间通信" tabindex="-1"><a class="header-anchor" href="#vue组件间通信" aria-hidden="true">#</a> <strong>Vue组件间通信</strong></h1><h1 id="一、总结" tabindex="-1"><a class="header-anchor" href="#一、总结" aria-hidden="true">#</a> <strong>一、总结</strong></h1><p>没错，先总结，后讲解</p><p><strong><strong>父子通信</strong></strong></p><p>父向子传递数据是通过 props，子向父是通过 events（$emit）；通过父链 / 子链也可以通信（$parent / $children）；ref 也可以访问组件实例；provide / inject API；$attrs/$listeners</p><p><strong><strong>兄弟通信</strong></strong></p><p>$Bus；Vuex</p><p><strong><strong>跨级通信</strong></strong></p><p>$Bus；Vuex；provide / inject API、$attrs/$listeners</p><h1 id="二、父传子-props" tabindex="-1"><a class="header-anchor" href="#二、父传子-props" aria-hidden="true">#</a> <strong>二、父传子 props</strong></h1><p>父组件通过v-bind绑定到子组件。子组件通过props接收传过来的值</p><p>总结：父组件通过props向下传递数据给子组件。注：组件中的数据共有三种形式：data、props、computed</p><blockquote><p>父组件示例：父子组件关联起来，并通过v-bind（即简写“：”）将父组件中的parentAge值，传递给子组件</p></blockquote><p>v-on绑定的属性名称deliverParentAge与data中定义的parentAge名称可以不一样</p><p>属性deliverParentAge通过v-bind绑定的，也是子组件中通过props接收的，而parentAge是要传递给子组件的数值，它是一个值</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>&lt;template&gt;
    &lt;div class=&quot;my-parent&quot;&gt;
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,69),l=[d];function a(r,v){return n(),i("div",null,l)}const c=e(t,[["render",a],["__file","组件通信.html.vue"]]);export{c as default};
