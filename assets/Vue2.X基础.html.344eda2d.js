import{_ as r,r as a,o as u,c as v,a as e,b as n,d as l,t as s,e as t}from"./app.37a6fc76.js";const o={},c=t('<h1 id="vue2-x-基础" tabindex="-1"><a class="header-anchor" href="#vue2-x-基础" aria-hidden="true">#</a> Vue2.X 基础</h1><h1 id="vue2-x-基础-指令、计算、侦听、修饰符等" tabindex="-1"><a class="header-anchor" href="#vue2-x-基础-指令、计算、侦听、修饰符等" aria-hidden="true">#</a> <strong>Vue2.X 基础（指令、计算、侦听、修饰符等）</strong></h1><h1 id="一、vue介绍" tabindex="-1"><a class="header-anchor" href="#一、vue介绍" aria-hidden="true">#</a> <strong>一、Vue介绍</strong></h1><p><strong><strong>Vue是什么？</strong></strong></p><blockquote><p>Vue：渐进式JavaScript框架</p></blockquote><p>Vue.js（读音 /vjuː/, 类似于 view） 是一套构建用户界面的渐进式框架。它的作者是位中国人–尤雨溪（EvanYou).</p><p>它提供了 MVVM 数据绑定和一个可组合的组件系统，具有简单、灵活的API。</p><p>很多使用过vue的程序员这样评价它，“vue.js兼具angular.js和react.js的优点，并剔除了它们的缺点”。</p>',8),p={href:"https://cn.vuejs.org/",target:"_blank",rel:"noopener noreferrer"},m={href:"https://cn.vuejs.org/v2/guide/",target:"_blank",rel:"noopener noreferrer"},g={href:"https://v3.cn.vuejs.org/guide/introduction.html",target:"_blank",rel:"noopener noreferrer"},b={href:"https://learning.dcloud.io/#/?vid=0",target:"_blank",rel:"noopener noreferrer"},h={href:"http://www.ruanyifeng.com/blog/2019/03/grid-layout-tutorial.html",target:"_blank",rel:"noopener noreferrer"},x={href:"https://element.eleme.cn/#/zh-CN",target:"_blank",rel:"noopener noreferrer"},f=t(`<div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>vue官网：https://cn.vuejs.org/v2/guide/
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong><strong>Vue的优点</strong></strong></p><ul><li>小而简单，轻量级框架，上手容易，简单易学，便于与第三方库或既有项目整合</li><li>只关注视图层，采用自底向上增量开发的设计</li><li>它的目标是通过尽可能简单的 API 实现响应的数据绑定和组合的视图组件</li><li>当与现代化的工具链以及各种支持类库结合使用时，Vue 也完全能够为复杂的单页应用提供驱动。</li><li>Vue封装了大量的组件,可以直接使用,简便而而美,省去了大量的Js代码.(有字体\\主题\\各种表单,表格,图标,按钮,提示框,导航栏等等)</li></ul><p><strong><strong>Element组件库</strong></strong></p>`,4),q={href:"https://element.eleme.cn/#/zh-CN",target:"_blank",rel:"noopener noreferrer"},k={href:"https://element.eleme.cn/#/zh-CN/component/installation",target:"_blank",rel:"noopener noreferrer"},V=e("p",null,"Element组件库：https://element.eleme.cn/#/zh-CN",-1),_=e("p",null,"Element文档：https://element.eleme.cn/#/zh-CN/component/installation",-1),y=e("p",null,[e("strong",null,[e("strong",null,"Vant组件库")])],-1),w=e("blockquote",null,[e("p",null,"基于 Vue2.X 和 Vue3.X 的 Mobile 组件库")],-1),M={href:"https://vant-contrib.gitee.io/vant/#/zh-CN/",target:"_blank",rel:"noopener noreferrer"},N={href:"https://vant-contrib.gitee.io/vant/v3/#/zh-CN",target:"_blank",rel:"noopener noreferrer"},O=t(`<p>Vant2.X文档：https://vant-contrib.gitee.io/vant/#/zh-CN/</p><p>Vant3.X文档：https://vant-contrib.gitee.io/vant/v3/#/zh-CN</p><h1 id="二、vue基础" tabindex="-1"><a class="header-anchor" href="#二、vue基础" aria-hidden="true">#</a> <strong>二、Vue基础</strong></h1><p><strong><strong>Vue的使用</strong></strong></p><p>创建一个 .html文件,然后通过如下方式引入Vue:</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>&lt;!-- 开发环境版本，包含了有帮助的命令行警告 --&gt;
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,135);function R(d,A){const i=a("ExternalLinkIcon");return u(),v("div",null,[c,e("p",null,[e("a",p,[n("Vue官网"),l(i)]),e("a",m,[n("Vue2.0手册"),l(i)]),e("a",g,[n("Vue3.0手册"),l(i)]),e("a",b,[n("Vue视频"),l(i)]),e("a",h,[n("grid布局"),l(i)]),e("a",x,[n("Element组件库"),l(i)])]),f,e("p",null,[e("a",q,[n("Element组件库"),l(i)]),e("a",k,[n("Element文档"),l(i)])]),V,_,y,w,e("p",null,[e("a",M,[n("Vant2.X文档"),l(i)]),e("a",N,[n("Vant3.X文档"),l(i)])]),O,e("ul",null,[D,S,j,e("li",null,s(d.message)+": 通过el和div做了绑定之后,可以直接通过"+s()+"双花括号的形式显示在data里的message的数据",1),e("li",null,"如果在别的div里写"+s(d.message)+"是不会显示'Hello Vue!'的,只会显示"+s(d.message)+",因为Vue实例只会去处理id为'app'的这个div里面的内容.",1)]),T,e("ol",null,[e("li",null,[C,e("ul",null,[X,e("li",null,[e("p",null,"v-text"+s()+"v-html",1)]),z,e("li",null,[e("p",null,[e("strong",null,s(),1)]),e("ul",null,[e("li",null,"vue 提供的 "+s()+" 语法，专门用来解决 v-text 会覆盖默认文本内容的问题。这种 "+s()+" 语法的专业名称是插值表达 式（英文名为：Mustache）。",1)]),H]),L])]),E]),P])}const J=r(o,[["render",R],["__file","Vue2.X基础.html.vue"]]);export{J as default};
